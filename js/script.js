...
// Terminal typing effect for code window
...
function createScrollToTopButton() {
    ...
    scrollBtn.addEventListener('mouseenter', () => {
        ...
        scrollBtn.style.boxShadow = '0 6px 25px rgba(0, 212, 255, 0.4)';
    });
    
    scrollBtn.addEventListener('mouseleave', () => {
        scrollBtn.style.transform = 'translateY(0)';
        scrollBtn.style.boxShadow = '0 4px 20px rgba(0, 212, 255, 0.3)';
    });
}
...
// Add some interactive elements to the terminal
document.addEventListener('DOMContentLoaded', () => {
    const terminal = document.querySelector('.code-window');
    if (terminal) {
        terminal.addEventListener('click', () => {
            // Add a subtle glow effect when clicked
            terminal.style.boxShadow = '0 0 30px rgba(0, 212, 255, 0.3)';
            setTimeout(() => {
                terminal.style.boxShadow = '0 10px 30px rgba(0, 0, 0, 0.3)';
            }, 300);
        });
    }
});
